...
* Defines
*/
/* Caso desejar utilizar outro broker MQTT, substitua o endereco abaixo*/ /*Sempre deixae tcp://*/
...
//Publica mensagens pre-definidas
void msgs(){
...
//Funções que trabalham baseado nas coordendas de GPS
/*************************************************************************************************************/
